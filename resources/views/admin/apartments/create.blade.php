        ...
        <div class="row">
            ...
            <div class="m-auto">
                <form action="{{route("admin.apartments.store")}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group m-auto col-12 col-sm-12 col-md-10">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button id="add_address" class="btn btn-outline-secondary" type="button">Aggiungi</button>
                            </div>
                            <input type="hidden" id="add_lat" name="lat">
                            <input type="hidden" id="add_lon" name="lon">
                            @error('address')
                    ...
                    <div id="services" class="form-group col-12 col-lg-6 col-sm-6 col-md-5">
                        Servizi :
                        ...
                        <button class="btn btn-primary btn-sm add-apartment" type="submit" name="button">
